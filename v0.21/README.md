...
| [v0.2](v0.2/) | `v0.2/` | 控制台 | 系统化重构 · 6技能/8敌人/4道具 · 百分比减伤公式 |
| v0.1 | [`master`](https://github.com/AAAgks/WordFightGame/tree/master) | 控制台 | 初版 · 基础战斗循环 |
...
- **百分比减伤**：`伤害 = ATK * 100 / (100 + DEF)`，防御永远不归零
- **防御姿态**：下回合受伤减半，攻防博弈
